...
//      ConstantCommand("\\"),
//      Seq(Binding, Term),
//      ToWidget(2, seq => WSequence(WCommand("λ"), WConstant(" "), seq(0), WConstant(" ⇒ "), seq(1))),
...
//      ConstantCommand("def"),
//      Seq(Binding, Term),
//      ToWidget(2, seq => WSequence(WCommand(), WConstant(" "), seq(0), WConstant(" = "), seq(1))),
